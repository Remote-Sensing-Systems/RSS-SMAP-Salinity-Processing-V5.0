...
do idir=1,2 
	...
	! ice zone 5
	! ice zone 6 (AMSR2 VL resolution close to land) and standard AMSR2 V8.1 flag set 
	...
	! changed in V5: I also flag if sss is < 1.5 or sss > 43.5
