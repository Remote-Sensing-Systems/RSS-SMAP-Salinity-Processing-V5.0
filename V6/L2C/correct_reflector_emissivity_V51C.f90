...
! adapted to B5.1C
! changed the routine name and call of the fd_delta_temp_refl_V51C subroutine


subroutine correct_reflector_emissivity_V51C
...
do idir=1,2 
    ...
    call fd_delta_temp_refl_V51C(secyr, xang,  delta_temp_refl)     
...
return
end subroutine correct_reflector_emissivity_V51C